...
# Update publish-to-rpm.yml
sed -i 'publish-to-rpm.yml' -e 's@siakhooi-buildo-[0-9.]*-1.fc43.noarch.rpm@siakhooi-buildo-'"$COMPONENT_VERSION"'-1.fc43.noarch.rpm@g'
sed -i 'publish-to-rpm.yml' -e 's@docs/siakhooi-buildo-[0-9.]*-1.fc43.noarch.rpm@docs/siakhooi-buildo-'"$COMPONENT_VERSION"'-1.fc43.noarch.rpm@g'
